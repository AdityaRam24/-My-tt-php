...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 31, 2024 at 11:58 AM
...
INSERT INTO `sub_has_slots` (`sub_name`, `S_id`) VALUES
('Operating Systems', 'S16'),
('Operating Systems', 'S17');
...
--
ALTER TABLE `sub_has_slots`
  ADD CONSTRAINT `sub_has_slots_ibfk_1` FOREIGN KEY (`sub_name`) REFERENCES `subject` (`subject_name`),
  ADD CONSTRAINT `sub_has_slots_ibfk_2` FOREIGN KEY (`S_id`) REFERENCES `slots` (`S_id`);
