                ...
                <div class="subjects">
                    ...
                    <div class="subject2">
                        <?php foreach ($subject_alc as $subject1): ?>
                            <div class="subject-button">
                                <button type="submit" value="<?= $subject1 ?>" name="subject_alc" style="background-color: transparent; border: 2px solid transparent; outline: none; height: 100px; width: 100px; border-radius: 2rem;"><?= $subject ?></button>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
